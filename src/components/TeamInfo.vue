...
<template>
  <div class="p-4 space-y-4 rounded">
      ...
      <div class="flex gap-1 h-1/2">
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="size-5 text-[#3B91F9] mx-auto"
          >
            <path
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="size-5 text-[#EB5757] mx-auto"
          >
    ...
    <div class="flex flex-wrap items-center justify-center gap-4 text-sm mt-4">
      <p><strong>Messages :</strong> {{ team.total_stat }}</p>
      <p><strong>Pénalités :</strong> {{ team.total_penality }}</p>
    </div>
  </div>
</template>
