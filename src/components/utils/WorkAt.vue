  ...
  <p class="flex">
    ...
    >
      ...
      <g clip-path="url(#meteoconsHazeDayFill9)">
        <use width="384" height="384" href="#meteoconsHazeDayFill7" transform="translate(64 100)" />
      </g>
      <use width="264" height="72" href="#meteoconsHazeDayFill8" transform="translate(124 336)" />
    </svg>
    <svg v-else xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
      ...
      <use width="264" height="72" href="#meteoconsHazeNightFill8" transform="translate(124 336)" />
    </svg>
  </p>
</template>
