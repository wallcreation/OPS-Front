     ...
     class="mx-1 hover:border-b-2 hover:border-primary-light">
      <span class="md:hidden"
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline pb-1">
          ...
          /></svg
      ></span>
      <span class="hidden md:inline">Accueil</span></RouterLink
    >
    <RouterLink class="mx-1 hover:border-b-2 hover:border-primary-light">
      <span class="md:hidden"
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" class="inline pb-1">
          <path
            fill="currentColor"
          ...
          /></svg
      ></span>
      <span class="hidden md:inline">Equipes</span></RouterLink
    >
    <RouterLink class="mx-1 hover:border-b-2 hover:border-primary-light"
      ><span class="md:hidden"
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline pb-1">
          ...
          /></svg
      ></span>
      <span class="hidden md:inline">Opérateurs</span></RouterLink
    >
    <RouterLink class="mx-1 hover:border-b-2 hover:border-primary-light">
      <span class="md:hidden"
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="inline pb-1">
